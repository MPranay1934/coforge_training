...
public class EmployeeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String result = "";
		try {
			Employee employee = service.findEmployeeById(eid);
			if(employee != null) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "Update":
		    ...
		    try {
		        ...
		        boolean updated = service.updateEmployeeSalary(eid, esalary);
		...
		case "Find":
			...
			try {
				employee = service.findEmployeeById(eid);
				if(employee != null)
...
//			     }
			...
			response.sendRedirect("indexx.jsp?result=" + result);
