...
public class EmployeeController {
	...
	public ResponseEntity<?> findDepartmentById(@PathVariable int dno) {
		ResponseEntity<?> responseEntity = null;
		DepartmentDTO departments = service.findDepartmentById(dno);
		if(departments != null)
		responseEntity = new ResponseEntity<>(departments, HttpStatus.OK);
		else 
			responseEntity = new ResponseEntity<>("FAILED : NOT FOUND", HttpStatus.BAD_REQUEST);
		return responseEntity;
	}
	
	@GetMapping("/employees/departments")
	public ResponseEntity<List> findAllDepartments() {
